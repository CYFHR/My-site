...
const Aboutdata: datatype[] = [
    {
        ...
        country: "POC on Blockchain and Hyperldeger Projects",
       

    },
    {
        imgSrc: "/assets/provide/graphic.svg",
        country: "Marketplace Development",
       

    },
    {
        imgSrc: "/assets/provide/heaking.svg",
        country: "Smart Contract Development and audit",
    ...
    //     paragraph: 'Smart Contract Development and audit',
    // },
]
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                    ...
                    <div className='col-span-6 flex justify-center'>
                        <div className="flex flex-col align-middle justify-center p-10">
                            <p className="text-4xl lg:text-6xl pt-4 font-semibold lh-81 mt-5 text-center lg:text-start">We provide Blockchain Services.</p>
                            <h4 className="text-lg pt-4 font-normal lh-33 text-center lg:text-start text-bluegray">We offer comprehensive blockchain solutions, including Proof of Concept (POC) development for Hyperledger projects, secure and user-friendly decentralized marketplace development, and robust smart contract creation and auditing to ensure efficiency and security.</h4>
